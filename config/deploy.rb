...
set :application, 'black-vulture'
set :repo_url, 'git@github.com:Fluvipers/black-vulture.git'

set :pty, true
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml')
set :linked_dirs, fetch(:linked_dirs, []).push('public/assets', 'public/system', 'public/uploads', 'log')

set :deploy_to, '/var/www/black-vulture/'
set :user, "deploy"
set :use_sudo, false 
set :ssh_options, { forward_agent: true }
set :rvm_type, :user
set :rvm_ruby_version, '2.2.3@black-vulture'
